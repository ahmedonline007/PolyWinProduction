        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgentLogo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AgentGovernorate = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TblAgent", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeOfCategory = table.Column<int>(type: "int", nullable: true),
                    AddedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TypeOfDescount = table.Column<int>(type: "int", nullable: true),
                    Descount = table.Column<decimal>(type: "decimal(16,2)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TblDescount", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorWhite = table.Column<int>(type: "int", nullable: true),
                    ColorBeige = table.Column<int>(type: "int", nullable: true),
                    ColorWooden = table.Column<int>(type: "int", nullable: true),
                    NumberIron = table.Column<int>(type: "int", nullable: true),
                    TypeOfProduct = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TblInvoicesDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TblInvoicesDetails_TblInvoices_InvoiceId",
                        column: x => x.InvoiceId,
                        principalTable: "TblInvoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TblInvoicesDetails_TblProducts_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TblInvoicesDetails_InvoiceId",
                table: "TblInvoicesDetails",
                column: "InvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_TblInvoicesDetails_ProductId",
                table: "TblInvoicesDetails",
                column: "ProductId");

...
const schema = Yup.object({
    description: Yup.string().required("برجاء إدخال وصف الداتا شيت").max(200, "الحد الاقصى للكتابة 200 حرف فقط"),
});
...
class DataSheet extends Component {
                        ...
                        <div>
                            ...
                            <OverlayTrigger
                                ...
                                <Button variant="danger" onClick={() =>
                                    this.setState({
                                        showImage: true,
                                        ImagePath: rowInfo.original.imagePath
                                    })
    ...
    componentDidMount() {
        this.props.actions.getAllDataSheets();
    }
    ...
    handleConfirm = () => {
        ...
        this.props.actions.deleteDataSheet(this.state.selected);
    }
    ...
    addEditDataSheet = (value) => {
        ...
        if (value.id > 0) {
            ...
            this.props.actions.addeditDataSheets(body);
        }
        else {
            if (this.state.file !== "") {
                const body = new FormData();
            ...
            <div className="content-page">
                <div className="content">
                    <div className="container-fluid">
                        <div className="row">
                            <div className="col-xl-12">
                                <div className="breadcrumb-holder">
                                    <h1 className="main-title float-left">الداتا شيت</h1>
                        ...
                        <ReactTable
                            ...
                            data={this.props.ListDataSheets}
                            columns={this.cells}
                        />
                    </div>
                </div>
                <Modal show={this.state.show} onHide={this.handleClose.bind(this)}>
                    <Modal.Header closeButton>
                        إضافة أو تعديل داتا شيت
                    </Modal.Header>
                    <Modal.Body className="modal-header">
                        <Formik validationSchema={schema} onSubmit={(values) => { this.addEditDataSheet(values) }}
                            initialValues={{
                                id: this.state.id,
...
const mapStateToProps = (state, ownProps) => ({
    ListDataSheets: state.reduces.ListDataSheets
});

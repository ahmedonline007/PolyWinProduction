                                    ...
                                    <Row>
                                        <Col>
                                            <Form.Group controlId="totalQuota">
                                                <Form.Label>عدد الاعواد فى اللفة / عدد القطع فى الكرتونة </Form.Label>
                                                <Form.Control type="text"
                                                    style={{ height: "50px" }}
                                                    placeholder="عدد الاعواد فى اللفة / عدد القطع فى الكرتونة"
                                                    onChange={handleChange}
                                                    aria-describedby="inputGroupPrepend"
                                                    name="totalQuota"
                                                    type="number"
                                        ...
                                        <Col>
                                            <Form.Group controlId="pricePerOne">
                                                <Form.Label>السعر العود أو الكرتونة</Form.Label>
                                                <Form.Control type="text"
                                                    style={{ height: "50px" }}
                                                    placeholder="السعر العود أو الكرتونة"
                                                    type="number"
                                                    onChange={handleChange}
                                                    aria-describedby="inputGroupPrepend"
                                                    name="pricePerOne"

...
class GallaryTypeImages extends Component {
    ...
    componentDidMount() {
        this.props.actions.getAllGalleryByType(1);
                        ...
                        <div className="row">
                            <div className="col-xl-12">
                                <div className="breadcrumb-holder">
                                    <h1 className="main-title float-left">تجسيل بيانات المعرض من نوع صور</h1>
...
export default connect(mapStateToProps, mapDispatchToProps)(GallaryTypeImages);
                    ...
                    <div className="sidebar-inner leftscroll">
                        <div id="sidebar-menu">
                            <ul>
                                ...
                                {
                                    this.state.userType === 1 ?
                                        <li className="submenu" onClick={() => this.handleLink(3)}>
                                            <a style={{ cursor: 'pointer' }} className={this.state.currentLink === 3 ? "subdrop" : ""}>
                                                <i className="fas fa-laptop"></i>
                                                <span> الحسابات </span>
                                                <span className="menu-arrow"></span>
                                            </a>
                                            <ul className="list-unstyled" style={{ display: this.state.currentLink === 3 ? "block" : "none" }}>

                                                {/*<li>*/}
                                                {/*    <NavLink to="/System/MainPurchase">*/}
                                                {/*        <span>الرئيسية</span>*/}
                                                {/*    </NavLink>*/}
                                                {/*</li>*/}
